...
//    Model objModel{};
//
//    mesh._verticesBuffer.resize(3);
//
//    mesh._verticesBuffer[0].position = { 1.f, 1.f, 0.0f };
//    mesh._verticesBuffer[1].position = {-1.f, 1.f, 0.0f };
//    mesh._verticesBuffer[2].position = { 0.f,-1.f, 0.0f };
//
//    mesh._verticesBuffer[0].color = { 0.f, 1.f, 0.0f }; //pure green
//    mesh._verticesBuffer[1].color = { 0.f, 1.f, 0.0f }; //pure green
//    mesh._verticesBuffer[2].color = { 0.f, 1.f, 0.0f }; //pure green
//
//    mesh._indexesBuffer = {0, 1, 2};
//
//    objModel.load_from_obj("../assets/monkey_smooth.obj");
//    engine->_meshManager->upload_mesh(mesh);
//    engine->_meshManager->upload_mesh(objModel);
//
//    engine->_meshManager->_models["monkey"] = objModel;
//    engine->_meshManager->_models["triangle"] = mesh;
//
//    // From init_scene
//    RenderObject monkey;
